...
function yes() {
    ...
    question.textContent = "I want to keep building this life together and perfecting our love!"
...
var gifs = ['../assets/hug-me-im-sad.gif', '../assets/goma-peach.gif', '../assets/cash-app-empty.gif', '../assets/sad.gif', 
                '../assets/cry-cute.gif', '../assets/reaction-sad.gif']
var noCount = 0
